...
![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252112890.png)
...
1. `连接器`：连接器负责和mysql服务器端**建立连接，获取权限，维持和管理连接**
   ...
   ![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252116918.png)
...
![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252119793.png)
...
![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252120128.png)
...
**示例**：![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252121333.png)
...
**示例**：![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252122045.png)
...
**示例**：![img](https://cdn.jsdelivr.net/gh/YuZhe727/xiaozhe_img/img/202310252122217.png)
...
6. mysql 联合索引使用 A>n and B=m 和 A=n and B=m 的区别
   ...
   第一部分（A列）是范围查询，无法利用到索引。因此，这种情况下，MySQL可能需要进行全表扫描来找到满足条件的记录。
